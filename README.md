...
- 아직 GitHub Secrets에 API 키를 하나도 등록하지 않은 상태라 **좌측은 비어 있고, 우측은 "관련 단체 홈페이지"에서 찾은 소수 항목만** 표시됩니다.
- 아래 "필요한 GitHub Secrets" 표의 키를 최소 1개 이상 등록하면 다음 수집(수동 실행 또는 익일 09:00)부터 정상적으로 채워집니다.
...
### 우측 — 고립청년 공모·지원사업 (검색/키워드 기반)

- 네이버·다음(카카오)·구글 포털에서 "고립청년 지원사업", "고립청년 공모사업" 키워드 검색
...
- 필터링은 느슨하게 운영 — 다소 부적합한 결과가 섞여도 허용
